    <nav class="flex justify-between px-4 pt-2 pb-2 border-b-[1px] border-black">
        <a href="{{ route('pages.index') }}" @if(Route::currentRouteName() == 'pages.index')class="active"@endif title="">Strona główna</a>
        <a href="{{ route('products.index') }}" @if(Route::currentRouteName() == 'products.index')class="active"@endif title="">Produkty</a>
